...
?>
    ...
    <div class="wrapper container mt-5">
        <h1 style ="color: black;">UPS!!!! parece que hubo algún problema</h1>      
            <button type="button" class="btn btn-primary" style="margin-top: 5px;"><a style="color: #333; text-decoration: none;" href="menu.php">Volver</a></button>
    </div>
